/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 3676c585f894a71d3ec0eb180395c2f6)
// Runtime types generated with workerd@1.20260820.1 2026-08-25 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	BOOKING_NOTIFICATION_LEDGER: DurableObjectNamespace<import("./custom-worker").BookingNotificationLedger>;
	WORKER_SELF_REFERENCE: Service<typeof import("./custom-worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "BookingNotificationLedger";
	}
